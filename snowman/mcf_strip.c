...
void fun_400c00(void** rdi, void** rsi);

void** fun_402090(void** rdi, void** rsi, int64_t rdx) {
    struct s0* r8_4;
    struct s0* rax5;
    void** r14_6;
    struct s0* rdx7;
...
int64_t fun_4012c0(struct s2* rdi, void** rsi, void* rdx);

void fun_400900(int64_t rdi, void** rsi);

int64_t fun_401310(struct s2* rdi, void** rsi, void* rdx) {
    int64_t rax4;
    void** rsp5;
    int64_t r15_6;
    void* r14_7;
...
void** fun_4026a0(void*** rdi, int64_t* rsi, void** rdx, void** rcx, void** r8, void** r9) {
    void** rax7;
    void** r9_8;
    void** rcx9;
    void** rcx10;
...
void** fun_402490(int64_t rdi, int64_t rsi, void** rdx, void** rcx, void** r8, void** r9, void** a7, void** a8, void** a9, struct s8* a10, void* a11, void** a12) {
    struct s8* r12_13;
    void* r11_14;
    void* r11_15;
    void** r13_16;
...
int64_t fun_400cf0(struct s9* rdi, void** rsi, void** rdx, void** rcx, void** r8, void** r9) {
    struct s10* r8_7;
    struct s10* rdi8;
    int64_t rax9;
    struct s10* rdx10;
...
void fun_402760(void** rdi, void** rsi, void** rdx) {
    void** rax4;
    void** rax5;
...
void fun_4029d0(uint64_t rdi, uint64_t rsi) {
    uint64_t r15_3;
    uint64_t rax4;
    int64_t r9_5;
    uint64_t r8_6;
...
void** fun_401a80(void** rdi, void** rsi) {
    uint64_t r8_3;
    int64_t rbx4;
    struct s0** v5;
    struct s0* r10_6;
...
struct s8* fun_402ad0(int64_t rdi, void** rsi, void** rdx, void** rcx, void** r8, void** r9);

int64_t fun_401120(struct s9* rdi, void** rsi, void** rdx, void** rcx, void** r8, void** r9);

int64_t fun_401220(struct s9* rdi, void** rsi, void** rdx, void** rcx, void** r8, void** r9);

int64_t fun_4027b0(struct s9* rdi, void** rsi) {
    void* rsp3;
    struct s9* r15_4;
    int64_t rdi5;
    void** rsi6;
    ...
    v10 = rsi6;
    rdx11 = r12_7;
    while (rax14 = fun_402ad0(rdi5, rsi6, rdx11, rcx8, r8_12, r9_13), rsp15 = reinterpret_cast<void*>(reinterpret_cast<int64_t>(rsp3) - 8 + 8), !!rax14) {
        ...
        rax23 = fun_4026a0(reinterpret_cast<int64_t>(rsp15) + 16, reinterpret_cast<int64_t>(rsp15) + 48, r14_21, rbp22, r8_12, r9_13);
        ...
        if (!rax23) {
            ...
            *reinterpret_cast<unsigned char*>(&rsi33) = reinterpret_cast<uint1_t>(rax14->f8 == rbp22);
            ...
            fun_402490(rdi26, rsi33, 1, rcx31, r8_12, r9_13, rax23, v35, 1, rax14, v32, v34);
            ...
            if (reinterpret_cast<int1_t>(rcx37 == ((reinterpret_cast<int64_t>(rax38) >> 7) + reinterpret_cast<uint32_t>(rdx39)) * 0xc8)) {
                rax40 = fun_400cf0(r15_4, rsi36, rdx39, rcx37, r8_12, r9_13);
                rsp3 = reinterpret_cast<void*>(reinterpret_cast<int64_t>(rsp3) - 8 + 8);
    ...
    rax41 = fun_400cf0(r15_4, rsi6, rdx11, rcx8, r8_12, r9_13);
    r15_4->f268 = r15_4->f268 + rax41;
    fun_401120(r15_4, rsi6, rdx11, rcx8, r8_12, r9_13);
    fun_401220(r15_4, rsi6, rdx11, rcx8, r8_12, r9_13);
    return 0;
}
...
void fun_400da0(struct s17* rdi, void** rsi) {
    struct s20* rax3;
    struct s20* r9_4;
    uint64_t r8_5;
    uint64_t rsi6;
...
int64_t fun_402190(struct s23* rdi, void** rsi, void* rdx) {
    struct s24* r10_4;
    int64_t* r8_5;
    struct s26* rdx6;
    struct s26* rsi7;
...
int64_t fun_400a20(struct s23* rdi, void** rsi, void* rdx) {
    int64_t r14_4;
    void** rsi5;
    void** rsi6;
    int1_t zf7;
    ...
    do {
        ...
        fun_4027b0(0x407cb0, rsi5);
        rsi6 = g407f08;
        fun_400840("simplex iterations         : %ld\n", rsi6);
        fun_400da0(0x407cb0, rsi6);
        fun_400840("objective value            : %0.0f\n", rsi6);
        ++r14_4;
        if (!r14_4) 
            break;
        zf7 = g407e68 == 0;
        if (!zf7 && (rsi6 = reinterpret_cast<void**>(0xffffffffffffffff), rax8 = fun_402090(0x407cb0, 0xffffffffffffffff, 0), !!rax8)) {
            rsi6 = rax8;
            fun_400840("erased arcs                : %ld\n", rsi6);
        }
        rax9 = fun_401a80(0x407cb0, rsi6);
        if (!rax9) 
            break;
...
int64_t fun_402340(int64_t rdi, void** rsi, void* rdx) {
    void** rbx4;
    void** rbp5;
    struct s0* r12_6;
    void** rsi7;
...
int64_t fun_400b10(int32_t edi, void** rsi) {
    uint32_t ebp3;
    void** rsi4;
    int64_t rax5;
    void** rsi6;
    ...
    if (edi >= 2) {
        ...
        rax5 = fun_401310(0x407cb0, rsi4, 0x270);
        if (!rax5) {
            rsi6 = g407e48;
            fun_400840("nodes                      : %ld\n", rsi6, "nodes                      : %ld\n", rsi6);
            fun_402190(0x407cb0, rsi6, 0x270);
            fun_400a20(0x407cb0, rsi6, 0x270);
            fun_400850("done", rsi6, "done", rsi6);
            rax7 = fun_402340("mcf.out", 0x407cb0, 0x270);
            fun_4012c0(0x407cb0, 0x407cb0, 0x270);
            ...
            fun_4012c0(0x407cb0, rsi4, 0x270);
        }
    }
...
void fun_401990(struct s36* rdi, struct s37* rsi, int64_t rdx, int64_t rcx, int64_t r8, int64_t r9) {
    int64_t rbx7;
    int64_t r11_8;
    int64_t r10_9;
    int64_t rdi10;
...
void fun_400f60(struct s38* rdi) {
    struct s41* rax2;
    struct s41* r9_3;
    uint64_t r8_4;
    uint64_t rsi5;
...
void fun_4018e0(int64_t* rdi, uint64_t rsi, int64_t rdx, int64_t rcx, int64_t r8, int64_t r9) {
    uint64_t rax7;
    uint64_t r11_8;
    uint64_t r10_9;
    uint64_t rax10;
...
int64_t fun_4029b0(struct s42* rdi, int64_t rsi) {
    int64_t rax3;
...
void fun_402dd0(int32_t edi, int64_t rsi, int64_t rdx) {
    int64_t r15_4;
    int32_t r13d5;
    int64_t r14_6;
    int64_t rbx7;
...
void fun_400940() {
    ...
    __libc_start_main(fun_400b10, __return_address(), rsp1, fun_402dd0, fun_402e40, rdx2, (reinterpret_cast<uint64_t>(rsp1) & 0xfffffffffffffff0) - 8 - 8, rax3);
    __asm__("hlt ");
}
